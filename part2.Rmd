...
sink("table_presentday.html")
cat(table_presentday)
sink()
...
wakereg1 <- lm(kfr_pooled_pooled_p25 ~ share_white2000 + share_black2000 + share_hisp2000 +
                                            ...
                                            data = wake_co, na.action = na.omit)
summary(wakereg1)

#Wake County model 2 w/o race
wakereg2 <- lm(kfr_pooled_pooled_p25 ~ 
                                             frac_coll_plus2000 + med_hhinc1990 + poor_share1990 +
                                             singleparent_share1990 + emp2000 + popdensity2000,
                                            data = wake_co, na.action = na.omit)
summary(wakereg2)
...
#Model 3
wakereg3 <- lm(kfr_pooled_pooled_p25 ~ 
                                             frac_coll_plus2000,
                                            data = wake_co, na.action = na.omit)
summary(wakereg3)

#Model 4
wakereg4 <- lm(kfr_pooled_pooled_p25 ~ 
                                            med_hhinc1990,
                                            data = wake_co, na.action = na.omit)
summary(wakereg4)

#Model 5
wakereg5 <- lm(kfr_pooled_pooled_p25 ~ 
                                            poor_share1990,
                                            data = wake_co, na.action = na.omit)
summary(wakereg5)

#Model 6
wakereg6 <- lm(kfr_pooled_pooled_p25 ~ 
                                            singleparent_share1990,
                                            data = wake_co, na.action = na.omit)
summary(wakereg6)

#Model 7
wakereg7 <- lm(kfr_pooled_pooled_p25 ~ 
                                            emp2000,
                                            data = wake_co, na.action = na.omit)
summary(wakereg7)

#Model 8
wakereg8 <- lm(kfr_pooled_pooled_p25 ~ 
                                            popdensity2000,
                                            data = wake_co, na.action = na.omit)
summary(wakereg8)
...
reg_table <- stargazer(wakereg1, wakereg2, wakereg3, wakereg4, wakereg5, wakereg6, type = "html",  
          title = "Series of regressions on upward mobility in Wake County",
          align = TRUE,
          column.labels = c("Full Covariate Model", "Model 2", "Model 3", "Model 4", "Model 5", "Model 6", "Model 7", "Model 8"),
